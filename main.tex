...
\usepackage{listings} % for proper code formatting
\usepackage{xcolor} % for colour

% Use whatever colur cheme you like here, this is the Overleaf example one found at https://www.overleaf.com/learn/latex/Code_listing
